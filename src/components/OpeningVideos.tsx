...
const getVideosForOpening = (openingName: string, count: number): OpeningVideo[] => {
  ...
  const videosByOpening: Record<string, OpeningVideo[]> = {
    ...
    "Giuoco Piano": [
     ...
     "Italian Game": [
      { id: "1", title: "Italian Game Tutorial", url: "https://www.youtube.com/watch?v=6ACqk117Q7U", difficulty: "Advanced" },
      { id: "2", title: "Italian Game Introduction", url: "https://www.youtube.com/watch?v=qUews8fEGkc", difficulty: "Advanced" },
      { id: "3", title: "Italian Game Paris Defense", url: "https://www.youtube.com/watch?v=Um0LlwI0qqE", difficulty: "Advanced" },
      { id: "4", title: "Italian Game Classical Line", url: "https://www.youtube.com/watch?v=9Q2oa73y5PU", difficulty: "Advanced" },
      { id: "5", title: "Italian Game Theoretical Lines", url: "https://www.youtube.com/watch?v=IREcO52zlYY", difficulty: "Advanced" },
      { id: "6", title: "Italian Game Positional Play", url: "https://www.youtube.com/watch?v=Qewug63GIqc", difficulty: "Advanced" },
      { id: "7", title: "Italian Game Opening", url: "https://www.youtube.com/watch?v=xhO774eUJXs", difficulty: "Advanced" },
      { id: "8", title: "Italian Game Strategy", url: "https://www.youtube.com/watch?v=8YP1iVMG_Rg", difficulty: "Advanced" },
      { id: "9", title: "Italian Game Modern Ideas", url: "https://www.youtube.com/watch?v=3w9-KWUL7k4", difficulty: "Advanced" },
      { id: "10", title: "Italian Game Evans Gambit", url: "https://www.youtube.com/watch?v=Bkg3TRGIDZs", difficulty: "Advanced" },
      { id: "11", title: "Italian Game Tactics", url: "https://www.youtube.com/watch?v=5aM6KP2VJtk", difficulty: "Advanced" },
      { id: "12", title: "Italian Game Complete Guide", url: "https://www.youtube.com/watch?v=I_VXU6dlYOM", difficulty: "Advanced" },
      { id: "13", title: "Italian Game Advanced", url: "https://www.youtube.com/watch?v=bFcBENHS6HA", difficulty: "Advanced" },
      { id: "14", title: "Italian Game Principles", url: "https://www.youtube.com/watch?v=xGttvOKOemk", difficulty: "Advanced" },
      { id: "15", title: "Italian Game Mastery", url: "https://www.youtube.com/watch?v=tOZKaAEZ0A0", difficulty: "Advanced" }
    ],
    "London System": [
      { id: "1", title: "London System Opening", url: "https://www.youtube.com/watch?v=49H728S_VjM", difficulty: "Advanced" },
      { id: "2", title: "London System Tutorial", url: "https://www.youtube.com/watch?v=4GcHcIekBSs", difficulty: "Advanced" },
       { id: "3", title: "London System Guide", url: "https://www.youtube.com/watch?v=_g1xMZhGOuc", difficulty: "Advanced" },
      { id: "4", title: "London System Strategy", url: "https://www.youtube.com/watch?v=ECMMct_jnEM", difficulty: "Advanced" },
      { id: "5", title: "London System Basics", url: "https://www.youtube.com/watch?v=soDuIX_jBWw", difficulty: "Advanced" },
      { id: "6", title: "London System Complete", url: "https://www.youtube.com/watch?v=bDRiAipADeA", difficulty: "Advanced" },
      { id: "7", title: "London System Ideas", url: "https://www.youtube.com/watch?v=ftAqYQQldJo", difficulty: "Advanced" },
      { id: "8", title: "London System Theory", url: "https://www.youtube.com/watch?v=EzNUiOR3Glo", difficulty: "Advanced" },
      { id: "9", title: "London System Explained", url: "https://www.youtube.com/watch?v=xVXqe_Rn-CA", difficulty: "Advanced" },
      { id: "10", title: "London System Mastery", url: "https://www.youtube.com/watch?v=hkhYu3DRTSQ", difficulty: "Advanced" },
      { id: "11", title: "London System Advanced", url: "https://m.youtube.com/watch?v=DIVQ0jAGh5c", difficulty: "Advanced" },
      { id: "12", title: "London System Course", url: "https://www.youtube.com/watch?v=EMcLzhJfxH0", difficulty: "Advanced" }
    ],
    "Four Knights Game": [
      { id: "1", title: "Four Knights Game Opening", url: "https://www.youtube.com/watch?v=432VtltHVaA", difficulty: "Advanced" },
      { id: "2", title: "Four Knights Game Tutorial", url: "https://www.youtube.com/watch?v=HizPoJ_2GPs", difficulty: "Advanced" },
      { id: "3", title: "Four Knights Game Guide", url: "https://www.youtube.com/watch?v=m9C7zbtUMqI", difficulty: "Advanced" },
      { id: "4", title: "Four Knights Game Strategy", url: "https://www.youtube.com/watch?v=zzgAPOoCKUc", difficulty: "Advanced" },
      { id: "5", title: "Four Knights Game Basics", url: "https://www.youtube.com/watch?v=2MlejTQPHEE", difficulty: "Advanced" },
      { id: "6", title: "Four Knights Game Complete", url: "https://www.youtube.com/watch?v=hKUTmN0ruYE", difficulty: "Advanced" },
      { id: "7", title: "Four Knights Game Ideas", url: "https://www.youtube.com/watch?v=QqPVNolnOfw", difficulty: "Advanced" },
      { id: "8", title: "Four Knights Game Theory", url: "https://www.youtube.com/watch?v=CSCtd9ge_GY", difficulty: "Advanced" },
      { id: "9", title: "Four Knights Game Explained", url: "https://www.youtube.com/watch?v=v7mvyshoZ54", difficulty: "Advanced" },
      { id: "10", title: "Four Knights Game Mastery", url: "https://www.youtube.com/watch?v=g8t0ygaEAAc", difficulty: "Advanced" }
    ],
    "Queen's Pawn Game": [
      { id: "1", title: "Queen's Pawn Game Opening", url: "https://www.youtube.com/watch?v=vEK8vPRlt2g", difficulty: "Advanced" },
      { id: "2", title: "Queen's Pawn Game Tutorial", url: "https://www.youtube.com/watch?v=q-pUpuzQM4k", difficulty: "Advanced" },
      { id: "3", title: "Queen's Pawn Game Guide", url: "https://www.youtube.com/watch?v=Dd05J-4LyB8", difficulty: "Advanced" },
      { id: "4", title: "Queen's Pawn Game Strategy", url: "https://www.youtube.com/watch?v=qcNN85OTZYU", difficulty: "Advanced" },
      { id: "5", title: "Queen's Pawn Game Basics", url: "https://www.youtube.com/watch?v=qlRms6SUz8E", difficulty: "Advanced" },
      { id: "6", title: "Queen's Pawn Game Complete", url: "https://www.youtube.com/watch?v=5J_v8RTDPug", difficulty: "Advanced" },
      { id: "7", title: "Queen's Pawn Game Ideas", url: "https://www.youtube.com/watch?v=eH1O3_550Wo", difficulty: "Advanced" },
      { id: "8", title: "Queen's Pawn Game Theory", url: "https://www.youtube.com/watch?v=yQwxPOabpWw", difficulty: "Advanced" }
    ],
    "Scandinavian Defense": [
      { id: "1", title: "Scandinavian Defense Opening", url: "https://www.youtube.com/watch?v=sKoBj-kL0hg", difficulty: "Advanced" },
      { id: "2", title: "Scandinavian Defense Tutorial", url: "https://www.youtube.com/watch?v=4Rrt0Lm176I", difficulty: "Advanced" },
      { id: "3", title: "Scandinavian Defense Guide", url: "https://www.youtube.com/watch?v=OGehkS76Q24", difficulty: "Advanced" },
      { id: "4", title: "Scandinavian Defense Strategy", url: "https://www.youtube.com/watch?v=Up9c5bbMJvE", difficulty: "Advanced" },
      { id: "5", title: "Scandinavian Defense Basics", url: "https://www.youtube.com/watch?v=A2J2OW99lGU", difficulty: "Advanced" },
      { id: "6", title: "Scandinavian Defense Complete", url: "https://www.youtube.com/watch?v=Wpd8jcVKcJw", difficulty: "Advanced" },
      { id: "7", title: "Scandinavian Defense Ideas", url: "https://www.youtube.com/watch?v=U1ATw8wSWos", difficulty: "Advanced" }
    ],
    "Vienna Game": [
      { id: "1", title: "Vienna Game Opening", url: "https://www.youtube.com/watch?v=JVxENCPcCjU", difficulty: "Advanced" },
      { id: "2", title: "Vienna Game Tutorial", url: "https://www.youtube.com/watch?v=6QQ5sw-SgNw", difficulty: "Advanced" },
      { id: "3", title: "Vienna Game Guide", url: "https://www.youtube.com/watch?v=FV67KSxkJQw", difficulty: "Advanced" },
      { id: "4", title: "Vienna Game Strategy", url: "https://www.youtube.com/watch?v=PbteFFxkZIc", difficulty: "Advanced" },
      { id: "5", title: "Vienna Game Basics", url: "https://www.youtube.com/watch?v=T64JJ5850sk", difficulty: "Advanced" },
      { id: "6", title: "Vienna Game Complete", url: "https://www.youtube.com/watch?v=USkSiL-TNQQ", difficulty: "Advanced" }
    ],
    "King's Gambit Declined": [
      { id: "1", title: "King's Gambit Declined Opening", url: "https://www.youtube.com/watch?v=3IxtBxB3H3s", difficulty: "Advanced" },
      { id: "2", title: "King's Gambit Declined Tutorial", url: "https://www.youtube.com/watch?v=YFydlMqz3gk", difficulty: "Advanced" },
      { id: "3", title: "King's Gambit Declined Guide", url: "https://www.youtube.com/watch?v=tCYNsrwyY-Q", difficulty: "Advanced" },
      { id: "4", title: "King's Gambit Declined Strategy", url: "https://www.youtube.com/watch?v=sKfwNPiFIhw", difficulty: "Advanced" },
      { id: "5", title: "King's Gambit Declined Basics", url: "https://www.youtube.com/watch?v=3OTKMrwHP3Y", difficulty: "Advanced" }
    ],
    "Philidor Defense": [
      { id: "1", title: "Philidor Defense Opening", url: "https://www.youtube.com/watch?v=v3XPmRIbono", difficulty: "Advanced" },
      { id: "2", title: "Philidor Defense Tutorial", url: "https://www.youtube.com/watch?v=mAf-YuGPYMo", difficulty: "Advanced" },
      { id: "3", title: "Philidor Defense Guide", url: "https://www.youtube.com/watch?v=Q4bp4qlRqGg", difficulty: "Advanced" },
      { id: "4", title: "Philidor Defense Strategy", url: "https://www.youtube.com/watch?v=6nEI2p3ftgk", difficulty: "Advanced" }
    ],
    "Slav Defense": [
